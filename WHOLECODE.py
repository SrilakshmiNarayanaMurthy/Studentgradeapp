...
class Student:
    ...
    def add_new_student(self, student_list):
        if any(student.email_address == self.email_address for student in student_list):
            ...
            print(f"Student record for {self.first_name} {self.last_name} has been added successfully.")  # Added message


    def delete_new_student(self, student_list):
        student_list.remove(self)
        write_students_to_csv("students.csv", student_list)
        print(f"Student record for {self.first_name} {self.last_name} has been deleted successfully.")  # Added message
...
class Professor:
    ...
    def delete_professor(self, professor_list):
        # Check if the professor exists by email
...
def write_students_to_csv(file_name, student_list):
    with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\student.csv", 'w', newline='') as file:
...
def write_courses_to_csv(file_name, course_list):
    with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\courses.csv", 'w', newline='') as file:
        writer = csv.writer(file)
...
def write_professors_to_csv(file_name, professor_list):
    with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\professors.csv", 'w', newline='') as file:
        writer = csv.writer(file)
...
def write_grades_to_csv(file_name, grade_list):
    with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\grades.csv", 'w', newline='') as file:
        writer = csv.writer(file)
...
def write_login_to_csv(file_name, user_list):
    ...
    with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv", 'w', newline='') as file:
        writer = csv.writer(file)
...
def read_students_from_csv(file_name):
    student_list = []
    try:
        with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\student.csv", 'r') as file:
...
def read_courses_from_csv(file_name):
    course_list = []
    try:
        with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\courses.csv", 'r') as file:
            reader = csv.reader(file)
            next(reader)  # Skip the header
            for row in reader:
...
def read_professors_from_csv(file_name):
    professor_list = []
    try:
        with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\professors.csv", 'r') as file:
            reader = csv.reader(file)
            next(reader)  # Skip the header
            for row in reader:
...
def read_grades_from_csv(file_name):
    grade_list = []
    try:
        with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\grades.csv", 'r') as file:
            reader = csv.reader(file)
            next(reader)  # Skip the header
            for row in reader:
...
def read_login_from_csv(file_name):
    ...
    user_list = []
    try:
        with open(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv", 'r') as file:
            reader = csv.reader(file)
            next(reader)  # Skip the header
            for row in reader:
...
def main():
    ...
    user_list = read_login_from_csv(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv")  # Load existing users from file
        ...
        if role == "1":
            while True:  # Keep inside the student menu until the user chooses to go back
                ...
                if student_choice == "1":
                    ...
                    if any(user['user_id'] == email for user in user_list):
                        ...
                        write_login_to_csv(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv", user_list)  # Write the updated list to the CSV file
                    ...
                    user_list = read_login_from_csv(r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv")
            ...
            while True:  # Keep inside the professor menu until the user chooses to go back
                ...
                if professor_choice == "1":
                    ...
                    login_file = r"C:\Users\Srilakshmi N Murthy\Desktop\MS 1st sem\sem 1 python\LAB1\login.csv"
